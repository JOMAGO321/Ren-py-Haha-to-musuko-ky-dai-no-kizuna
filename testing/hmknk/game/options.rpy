...
define config.name = _("Haha to musuko kydai no kizuna")
...
define build.name = "Hahatomusukokydainokizuna"
...
define config.save_directory = "Hahatomusukokydainokizuna-1772834631"
